...
const hlsStreams = [
  ...
  { uri: 'https://s3.amazonaws.com/roku-anthony.van.alphen-test/video/portugal-vs-mexico/index.m3u8', type: 'HLS' },
  ...
  { uri: 'http://iphone-streaming.ustream.tv/uhls/9408562/streams/live/iphone/playlist.m3u8', type: 'HLS' },
  ...
  { uri: 'http://b028.wpc.azureedge.net/80B028/Samples/0e8848ca-1db7-41a3-8867-fe911144c045/d34d8807-5597-47a1-8408-52ec5fc99027.ism/Manifest(format=m3u8-aapl-v3)', type: 'HLS' },
...
export default (state, action) => {
  ...
  switch(DeviceInfo.getSystemName()) {
    case 'iOS':
    case 'tvOS':
      return [ ...fairplayStreams, ...hlsStreams ];
    case 'android':
      return [ ...widevineStreams, ...dashStreams ];
    default:
      return [ CLEARStream ];
  }
};

export { DASHStream, FairPlayStream, CLEARStream };
